...
export default function ChooseUs() {
    return (
        <>
            <div className="block md:hidden mt-16 p-4 relative">
                <div className='absolute top-0 left-1/2 z-10'>
                    <img src="/assets/kamathenu Images/About/OrderNow/img1.png" alt=" img_logo" className='w-full h-48' />
                </div>
                <div className="bg-[#FFCE53] mt-8 p-6 relative">
                    <h1 className='text-base text-white font-normal mt-8'>WE WORK WITH</h1>
                    <h1 className='text-xl font-bold mt-2'>WHY CHOOSE US</h1>
                    <p className='text-sm mt-2 w-full text-[#1A1A1ABF] leading-relaxed'>Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been.Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem IpsumLorem</p>

                    <div className='flex flex-col gap-6 mt-8'>
                        <div className="text-center">
                            <img src="/assets/kamathenu Images/About/OrderNow/aff_logo.png" alt="" className="mx-auto w-16 h-16" />
                            <h1 className='text-lg font-semibold mt-3'>Affordable Pricing</h1>
                            <p className='text-sm mt-2 text-[#1A1A1ABF] leading-relaxed'>Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been.Lorem Ipsum is simply</p>
                        </div>

                        <div className="text-center">
                            <img src="/assets/kamathenu Images/About/OrderNow/pro_logo.png" alt="" className="mx-auto w-16 h-16" />
                            <h1 className='text-lg font-semibold mt-3'>Affordable Pricing</h1>
                            <p className='text-sm mt-2 text-[#1A1A1ABF] leading-relaxed'>Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been.Lorem Ipsum is simply</p>
                        </div>

                        <div className="text-center">
                            <img src="/assets/kamathenu Images/About/OrderNow/Quick.png" alt="" className="mx-auto w-16 h-16" />
                            <h1 className='text-lg font-semibold mt-3'>Affordable Pricing</h1>
                            <p className='text-sm mt-2 text-[#1A1A1ABF] leading-relaxed'>Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been.Lorem Ipsum is simply</p>
                        </div>

                        <div className="text-center">
                            <img src="/assets/kamathenu Images/About/OrderNow/settingLogo.png" alt="" className="mx-auto w-16 h-16" />
                            <h1 className='text-lg font-semibold mt-3'>Affordable Pricing</h1>
                            <p className='text-sm mt-2 text-[#1A1A1ABF] leading-relaxed'>Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum has been.Lorem Ipsum is simply</p>
                        </div>
                    </div>
            ...
            <div className='hidden md:block mt-22 lg:mt-22 p-19 relative'>
                <div className='absolute top-0 left-1/2 z-10'>
